...
row=question_number+input_box+question_button;
...
function check(){
    ...
    {
        question_turn="player1"
        document.getElementById("player_question").innerHTML="para preguntar-"+player1;
    }
...
if(answer_turn == "player1")
 {
     answer_turn = "player2"
      ...
      document.getElementById("player_answer").innerHTML = "Answer Turn - " + player1_name ; } document.getElementById("output").innerHTML = ""; }
